...
let Interactable = (() => {
    let Interactable = class Interactable extends base_entity_1.BaseEntity {
    };
    __decorate([
        typeorm_1.ManyToMany(type => ancestry_entity_1.Ancestry),
        typeorm_1.JoinTable(),
        __metadata("design:type", Array)
    ], Interactable.prototype, "abilities", void 0);
    __decorate([
        typeorm_1.ManyToMany(type => background_entity_1.Background),
        typeorm_1.JoinTable(),
        __metadata("design:type", Array)
    ], Interactable.prototype, "backgrounds", void 0);
    __decorate([
        typeorm_1.ManyToMany(type => class_entity_1.Class),
        typeorm_1.JoinTable(),
        __metadata("design:type", Array)
    ], Interactable.prototype, "classes", void 0);
    Interactable = __decorate([
        typeorm_1.Entity({ name: 'interactable' })
    ], Interactable);
    return Interactable;
})();
exports.Interactable = Interactable;
//# sourceMappingURL=interactable.entity.js.map